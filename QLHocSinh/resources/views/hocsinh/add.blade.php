...
<div class="content">
	<div class="container-fluid">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-content">
						<h4 class="card-title">Thêm mới học sinh
						</h4>
						<form id="addHocSinh" action="{{ url('/add-hoc-sinh.html') }}" method="post" role="form">
							{{ csrf_field() }}
							<!-- Normal Information -->
							<div class="row">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									...
									<div class="col-md-2">
										...
										@foreach($namhoc as $item)
											<option value="{{ $item->MaNamHoc }}">{{ $item->TenNamHoc }}</option>
										@endforeach
									</select>
								</div>
								<div class="col-md-2 dropdown-label">
		...
		<div class="pull-right">
			...
			<button type="submit" class="btn btn-success btn-fill">Thêm học sinh</button>
